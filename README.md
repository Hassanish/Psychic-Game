...
6. Choose whichever game you'd like to build. Making the Psychic game will prove less challenging than coding Hangman. Given the speed of the program we suggest starting with the Psychic game.

7. Push your selected game to Github Pages.


## Option One: Psychic Game (Recommended)
...
## Option Two: Hangman Game (Challenge - Extended)
